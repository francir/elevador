...
namespace Elevador
{
    public class Elevador : IElevador
    {
        ...
        public Enums.StatusPorta StatusPorta
        {
            get
            {
                return StatusPorta;
            ...
            {
                StatusPorta = value;
                if (StatusPorta == Enums.StatusPorta.Aberta || Rota == null)
        ...
        void m_mainTimer_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
        {
            ...
            //Abre a porta e reinicia o tempo de espera com a porta aberta para receber novos comandos e calcular nova rota, caso exista
            StatusPorta = Enums.StatusPorta.Aberta;
            m_mainTimer.Start();
        }
        ...
        protected void MoverPara(Rota rota)
        {
            ...
            //Ao chegar no destino, atualizar o status para parado
            StatusElevador = Enums.StatusElevador.Parado;
        }
